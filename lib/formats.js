...
const marcTransform = recordTransform(Record.fromMarc)
const picaTransform = recordTransform(Record.fromPica)
const flatTransform = recordTransform(Record.fromFlat)
